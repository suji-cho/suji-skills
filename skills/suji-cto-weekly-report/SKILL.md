...
파일 경로: `~/Workspace/work/project/project_done/competitor_tracker/history.json`
...
파일 경로: `~/Workspace/work/project/project_done/competitor_tracker/history.json`의 `x_post_metrics` 섹션
