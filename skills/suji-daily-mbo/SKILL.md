...
3. **할일 자동 수집**:
   ...
   - 프로젝트 카드 (`work/project/project_todo/*.md`, done/ 제외) 미완료 항목
4. **수집 결과 보여주기**: 테이블 형태로 후보 제시. "🔁 어제 완료 — 이어가는지 확인" 블록을 별도 표기하여 각 항목의 계속/종료 여부를 물을 것.
5. **사용자 선택**: 오늘 할일 선택 (이어가는 항목은 계속/종료 판단 포함)
...
- `work/project/project_todo/`: 프로젝트 태스크 카드 (할일 수집 소스)
